    ...
    return (
        <form onSubmit={loginUser} className="uk-form-horizontal uk-margin-large">
            ...
            <p className="uk-margin">
                <button className="uk-button uk-button-primary" type="submit">Login
                </button>
            </p>
            <p className="uk-margin">
...
function Login({cookies}) {
    ...
    return (
        <div>
                ...
                <div className="uk-navbar-center">
                    <div className="uk-navbar-item">
                        <form className="uk-search uk-search-navbar">
                            ...
                            <input name="query" className="uk-search-input"
            ...
            <div
                className="uk-card uk-card-default uk-card-body uk-width-1-4@m uk-align-center">
